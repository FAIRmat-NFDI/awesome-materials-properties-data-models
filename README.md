...
- [Kittel, Charles. Introduction to Solid State Physics. Wiley, 2004](https://www.wiley.com/en-us/Introduction+to+Solid+State+Physics%2C+8th+Edition-p-9780471415268): A standard solid state physics book with chapters dedicated with definitions and derivations for various material properties. 
